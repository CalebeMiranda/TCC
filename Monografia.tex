...
Este capítulo aborda alguns trabalhos relacionados ao refinamento e integração do modelo LLM-Compiler para otimização de código
alvo para microcontroladores pertencentes a família AVR, na Robotics Language. Primeiramente será analizado os principais critérios de seleção para estes trabalhos
que abordam áreas diretamente ligadas ao escopo desta pesquisa, posteriormente será apresentado um breve resumo sobre cada trabalho e suas
contribuições.

\section{Metodologia de Análise}
Para a anáilse dos trabalhos relacionados, foram considerados

\section{Trabalhos analisados}

Considerando os critérios anteriores, foram analisados obras com maior relevância sobre o tema, que abordam de forma direta ou indiretamente o processo de treinamento/refinamento do modelo de IA,
geração de datasets e otimização da compilação de programas, em específico redução de tamanho de código. Destaca-se os 3 artigos a seguir que foram selecionados conforme sua prioridade de contribuições 
para a presente pesquisa.

\subsection{LLM-COMPILER}

O trabalho de \cite{cummins2023large} 

\subsection{Good Optimization Sequences Covering Program Space}

O trabalho de \cite{PuriniJain2013}

\subsection{Optimization Sequences for Code-Size Reduction}

O trabalho de \cite{faustino2021new}
